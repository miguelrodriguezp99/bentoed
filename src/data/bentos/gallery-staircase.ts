...
export const galleryStaircase: BentoEntry = {
  meta: {
    id: 'gallery-staircase',
    name: 'Staircase Gallery',
    category: 'gallery',
    columns: 12,
    itemCount: 5,
    description: 'Staircase pattern gallery with cascading item placement',
    tags: ['gallery', 'staircase', 'grid', 'responsive'],
  ...
  code: {
    ...
    >
      ...
      <div class="col-span-12 lg:col-start-5 lg:col-span-4 group overflow-hidden rounded-md">
        <img
      ...
      <div class="col-span-12 lg:col-start-9 lg:col-span-4 group overflow-hidden rounded-md">
        <img
      ...
      <div class="col-span-12 lg:col-span-6 group overflow-hidden rounded-md">
        <img
