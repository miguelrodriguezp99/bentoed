...
export const galleryFeaturedRow: BentoEntry = {
  meta: {
    id: 'gallery-featured-row',
    name: 'Featured Row Gallery',
    category: 'gallery',
    columns: 12,
    itemCount: 5,
    description: 'One large featured item with smaller items stacked on the right',
    tags: ['gallery', 'featured', 'asymmetric', 'responsive'],
    createdAt: '2024-01-15',
  },
  code: {
    html: `
    <div id="gallery-featured-row" class="bt-div">
    ...
    >
      <div class="col-span-12 row-span-4 md:col-span-8 md:row-span-4 group overflow-hidden rounded-xl hover:scale-[1.02] transition-transform duration-500">
      ...
      <div class="col-span-6 row-span-2 md:col-span-4 md:row-span-1 group overflow-hidden rounded-xl hover:scale-[1.02] transition-transform duration-500">
